...
namespace Feedback_Application
{
    partial class QuestionsForm
    {
        ...
        private MetroFramework.Controls.MetroCheckBox createCheckBox(int startPosition, int endPosition, int i, string text, System.Windows.Forms.Panel mainPanel)
        {
        ...
        private int createMultipleChoicePanel(System.Windows.Forms.Panel panel, List<Question> pitanja, int startPosition, int endPosition)
        {
            ...
            for (int j = 0; j < qa.Count; j++)
            {
                if (qa[j].Answer.IsApicture.Equals(true))
                {
                    ...
                    MetroFramework.Controls.MetroButton cb = createRadioButton(startPosition, endPosition, j, "", panel, qa[j].Answer.IsApicture, baseS);
                ...
                {
                    endPosition += 50;
                    MetroFramework.Controls.MetroButton cb = createRadioButton(startPosition, endPosition, j, qa[j].Answer.AnswerText, panel, qa[j].Answer.IsApicture, baseS);
                    endPosition += 130;
                }
        ...
        private int createSingleChoicePanel(System.Windows.Forms.Panel panel, List<Question> pitanja, int startPosition, int endPosition)
        {
            ...
            for (int j = 0; j < qa.Count; j++)
            {
                ...
                {
                    endPosition += 130;
                    MetroFramework.Controls.MetroButton rb = createRadioButton(startPosition, endPosition, j, " ", panel, qa[j].Answer.IsApicture, qa[j].Answer.Base64);
